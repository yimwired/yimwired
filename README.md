...
I build things that ship — web experiences, AI agents, trading systems and content pipelines. Designed, built and operated end to end, solo.
...
`Next.js` `React` `TypeScript` `Tailwind` `Framer Motion` `Three.js` · `Python` `MT5` · `Claude API` `agent fleets` · `ffmpeg` pipelines
